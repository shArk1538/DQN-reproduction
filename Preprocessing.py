...
# from gymnasium.wrappers.atari_preprocessing import AtariPreprocessing  # 可以直接用官方封装的函数
...
def atari_preprocess(env, episode_life=True, clip_rewards=True, frame_stack=True, scale=True):
    """
    ...
    if clip_rewards:
        env = ClipRewardEnv(env) # clip the reward into [-1,1] (-1,0,1)
    if frame_stack:
